...
def generate_numeric_chart(df, column_name, output_dir):
    """Generate histogram for numeric column and save it."""
...
def generate_categorical_chart(df, column_name, output_dir):
    """Generate bar chart for top 5 categorical values."""
    if column_name not in df.columns:
        return None
